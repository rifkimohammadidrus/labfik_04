<main class="akun-container">
    ...
    <?= form_open_multipart('user/surat_tugas'); ?>
    <div class="card-body">
        <h5>Data Kegiatan</h5>
        <hr><br>
                    ...
                    <div class="form-group" style="margin-bottom:12;">
                        <div class="row">
                            <div class="col-md-11" style="margin-bottom:12px">
                                ...
                                <input type="file" name="eviden[]" id="eviden" class="form-control" style="padding:13px 16px" required="" value="<?= set_value('eviden[]') ?>">
    ...
    jQuery(function() {
        ...
        jQuery("#jenis_penugasan").change(function() {
            ...
            if (value == "Kepanitiaan") {
                ...
                $("#kepanitiaan").show();
                $("#tambahPanitia").show()
                // } else if (value == <?= set_select('jenis_penugasan', 'Kepanitiaan'); ?>) {
                //     $("#tambahDivisi").show();
                //     $("#kepanitiaan").show();
                //     $("#tambahPanitia").show()
            } else {
