    ...
    <div class="container">
        ...
        ?>
            ...
            ?>
                ...
                <p>Menugaskan kepada dosen dan TPA yang tercantum pada lampiran surat tugas ini,
                    sebagai <?= $srt->nama_kegiatan ?> yang diselenggarakan oleh
                    <?= $srt->penyelenggara ?>. </p>
                ...
                <p>Tembusan : <br> Wakil Dekan Bidang Sumber Daya, Keuangan dan Kemahasiswaan FIK</p>
            <?php endforeach; ?>
            ...
            <div class="page"></div>
            <p>Lampiran Surat Tugas Nomor <?= $srt->no_surat ?></p>
            <p style="text-align: center;"><b>Susunan Kepanitiaan <?= $srt->nama_kegiatan ?></b></p>
            <table class="table" style="border-collapse: collapse; width: 100%;">

                <tbody style="border-collapse: collapse;">
                    <?php $arrID = explode(",", $srt->dosen_id);  ?>
                    <?php $getDivisi = explode(",", $srt->divisi);
                    $no = 0;
                    ?>
                    <?php foreach ($arrID as $id) : ?>
                        <tr>
                            <td><b><?= $getDivisi[$no++] ?></b></td>
                            <td><?= $dosen[$id]->name ?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
