    ...
    <div class="container loss">
        ...
        <div class="navbar-brand akun">
            <a href="<?= base_url('user/index') ?>">
                <script data-pagespeed-no-defer type="8adbcf2d5865138ccf152acc-text/javascript">
                    //<![CDATA[
                    (function() {
                    ...
                    pagespeed.CriticalImages.Run('/mod_pagespeed_beacon', 'https://ifik.telkomuniversity.ac.id/users', '82dtZm2p5Q', true, false, 'vB8nKGvw6d8');
                    //]]>
                </script>
                <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="8adbcf2d5865138ccf152acc-|49"></script><img src="https://ifik.telkomuniversity.ac.id/assets/img/logo/logo-dummy.png" data-pagespeed-url-hash="2464562771" onload="pagespeed.CriticalImages.checkImageForCriticality(this);" />
            </a>
        </div>
        <div class="fik-navbar-menu">
            <ul class="left akun fik-username hide-mobile">
                <li>
                    <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="8adbcf2d5865138ccf152acc-|49"></script><img src="https://ifik.telkomuniversity.ac.id/assets/img/profile/default.jpg" data-pagespeed-url-hash="1115005048" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                </li>
                <li>
                    <b><?= $user['name']; ?></b>
                    <?= $title; ?>
                ...
                <div class="dropdown not-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <div class="dropdown-item regisdropdown">
                            <a class="dropdown-item" href="https://ifik.telkomuniversity.ac.id/auth/editprofiledsn">
