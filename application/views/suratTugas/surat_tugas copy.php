            ...
            foreach ($surat as $srt) : ?>
                ...
                <tbody class="sorotan " title="Detail Surat">
                    <tr bgcolor="<?= $rowColor[$srt->stat]; ?>">
                        <!-- <th data-toggle="modal" data-target="#detail<?= $srt->id; ?>"></a></th>
                        ...
                        <th>
                            <a href="<?= base_url() ?>suratTugas/detail" value="<?= $srt->id; ?>"><?= $no++ ?></a>
                            </form>
                        </th>
                        <td data-toggle="modal" data-target="#detail<?= $srt->id; ?>"><a href="<?= base_url() ?>suratTugas/detail"><?= $srt->nama_kegiatan ?></a></td>
                        <td data-toggle="modal" data-target="#detail<?= $srt->id; ?>"><?= $srt->no_ememo ?></td>
                        <td data-toggle="modal" data-target="#detail<?= $srt->id; ?>"><?= $srt->periode_penugasan ?></td>
                        <td data-toggle="modal" data-target="#detail<?= $srt->id; ?>"><?= $status[($srt->stat) - 1]->status ?></td>
                            ...
                            <?php if ($srt->stat == '1' or $srt->stat == '4' or $srt->stat == '7') : ?>
                                <td>
                                    <form action="<?= base_url(); ?>suratTugas/detail" method="POST" enctype="multipart/form-data">
                                        ...
                                        <button type="submit" name="detailSurat" value="detailSurat" class="badge badge-primary text-light " id="detailSurat" style="margin-bottom:2px;width: 45px;">Detail</button>
                                    </form>
